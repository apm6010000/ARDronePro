...
{
  vp_os_mutex_lock(&video_update_lock);  // Mutex for Video
  vp_os_mutex_lock( &control_data_lock ); //Mutex for Control
 //Mutex for Control
  ...
  vp_os_mutex_unlock( &video_update_lock );
        ...
        if( c == -1 )
        {
            control_data.roll = 0;control_data.pitch = 0; control_data.gaz=0; control_data.yaw=0;
        }
        else if( c == 'A' || c=='a' )
        {
            control_data.roll = -1;
            control_data.pitch = 0; control_data.gaz=0; control_data.yaw=0;
        }
        else if( c == 'D' || c=='d' )
        {
            control_data.roll = 1;
        ...
        {
            control_data.pitch = -1;
            control_data.roll = 0; control_data.gaz=0; control_data.yaw=0;
        }
        else if( c == 'S' || c=='s' )
        {
            control_data.pitch = 1;
        ...
        {
            control_data.yaw = 1;
            control_data.roll = 0; control_data.gaz=0; control_data.pitch=0;
        }
        else if( c == 'L' || c=='l' )
        {
            control_data.yaw = -1;
        ...
        {
            control_data.gaz = -1;
            control_data.roll = 0; control_data.pitch=0; control_data.yaw=0;
        }
        else if( c == 'K' || c=='k' )
        {
            control_data.gaz = 1;
